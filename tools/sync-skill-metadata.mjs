...
const skills = [
    ...
    {
        accent: "#F97316",
        displayName: "Socket Management",
        glyph: "M160 152h192v64H160zM128 248h256v112H128zM192 216v32M320 216v32M184 304h48M280 304h48",
        longTitle: "Socket Management",
        name: "socket-management",
        prompt: "Use $socket-management to inspect and manage Socket supply-chain security safely.",
        shortDescription: "Inspect and manage Socket safely",
        shortTitle: "SOC",
    },
    {
        accent: "#4C3FB3",
        displayName: "Snyk Management",
        glyph: "M256 112l136 72v144l-136 72-136-72V184zM192 208h128M192 256h96M192 304h128M320 288l32 32 56-72",
        longTitle: "Snyk Management",
        name: "snyk-management",
        prompt: "Use $snyk-management to inspect and manage Snyk projects, findings, and policy safely.",
        shortDescription: "Inspect and manage Snyk safely",
        shortTitle: "SNYK",
    },
    {
        accent: "#7C3AED",
        displayName: "StepSecurity Management",
        glyph: "M256 104l136 56v88c0 88-56 144-136 176-80-32-136-88-136-176v-88zM184 256l48 48 96-112",
        longTitle: "StepSecurity Management",
        name: "stepsecurity-management",
        prompt: "Use $stepsecurity-management to investigate and manage StepSecurity Actions security safely.",
        shortDescription: "Manage Actions runtime security",
        shortTitle: "STEP",
    },
    {
        accent: "#8B5CF6",
    ...
    {
        accent: "#16A34A",
        displayName: "WakaTime Management",
        glyph: "M256 112a144 144 0 110 288 144 144 0 010-288zM256 168v96l72 48M160 376h192",
        longTitle: "WakaTime Management",
        name: "wakatime-management",
        prompt: "Use $wakatime-management to inspect WakaTime activity, projects, goals, and exports safely.",
        shortDescription: "Inspect WakaTime activity safely",
        shortTitle: "WAKA",
    },
    {
        accent: "#2563EB",
